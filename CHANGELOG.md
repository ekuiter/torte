...
- Fixed race condition in parallel execution of sbva_cadical

## [2.1.0] - 2025-12-19

### Added

- Added fine-grained restriction mechanism to skip specific actions

### Fixed

- Fixed incorrect lookup of features files in query samples

## [2.0.1] - 2025-12-15

### Fixed

- Fixed regression in the extraction of Freetz-NG due to a changed mirror for LKC
